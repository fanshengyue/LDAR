...
/**
 * Created by fanshengyue on 2017/1/18.
 * 自定义容器，盛放listview,gridview,scrollview
 */
...
//        mHeaderImageView.setBackgroundResource(R.drawable.pullanimation);
        animationDrawable= (AnimationDrawable) mHeaderImageView.getBackground();
...
//        mHeaderImageView.setImageResource(R.drawable.pull_arrow_dowm);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
...
//        mFooterImageView.setImageResource(R.drawable.pull_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
