...
public class EnterpriseDao extends AbstractDao<Enterprise, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Legal_persion = new Property(3, String.class, "legal_persion", false, "LEGAL_PERSION");
    ...
    protected void readEntity(Cursor cursor, Enterprise entity, int offset) {
        ...
        entity.setLegal_persion(cursor.getString(offset + 3));
        entity.setIndustry(cursor.getString(offset + 4));
        entity.setCreate_time(cursor.getString(offset + 5));
    ...
    protected void bindValues(DatabaseStatement stmt, Enterprise entity) {
        ...
        stmt.bindString(4, entity.getLegal_persion());
        stmt.bindString(5, entity.getIndustry());
        stmt.bindString(8, entity.getCreate_time());
        stmt.bindLong(9, entity.getValid());
        stmt.bindLong(10, entity.getNid());
        stmt.bindLong(11, entity.getPpid());
        stmt.bindLong(12,entity.getEpid());
    }
