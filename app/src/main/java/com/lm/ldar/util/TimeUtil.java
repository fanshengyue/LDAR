...
/**
 * Created by fanshengyue on 2018/3/16.
 */
...
//                        tvTime.setText(getTime(date));
        ...
        pvTime.setEmptyCallBack(new TimePickerView.EmptyCallBack() {
            @Override
    ...
    public static void alertBottomWheelOption(Context context, ArrayList<?> list, final OnWheelViewClick click) {
        ...
        wv_option.setTextSize(context.getResources().getDimensionPixelSize(com.bigkoo.pickerview.R.dimen.pickerview_textsize));
        ...
        Button btEmpty= (Button) view.findViewById(R.id.btnEmpty);
